...
const Header = () => {
  ...
  return (
    <Container fluid className='bg-[#070d2b]'>
      <Container>
        <div className='py-2 text-white border-b border-gray-600'>
          <div className='flex items-center justify-between'>
            ...
            <div className='hidden lg:block font-semibold'>
              <ul className='flex gap-6 hover:cursor-pointer'>
                ...
                <li className='mx-2 hover:cursor-pointer hover:text-[#ff084a]'> Home</li>
                <li className='mx-2 hover:cursor-pointer hover:text-[#ff084a]'> Funkcion</li>
                <li className='mx-2 hover:cursor-pointer hover:text-[#ff084a]'> Prices</li>
                <li className='mx-2 hover:cursor-pointer hover:text-[#ff084a]'> Blogs</li>
                <li className='mx-2 hover:cursor-pointer hover:text-[#ff084a]'> FAQs</li>
                <li className='mx-2 hover:cursor-pointer hover:text-[#ff084a]'> Contact Us</li>
              </ul>
            </div>
            ...
            <div className='block cursor-pointer lg:hidden z-10'>
              ...
              <ul className={` fixed h-full w-full md:h-[390px] bg-[#070d2b] top-[75px] lg:hidden
